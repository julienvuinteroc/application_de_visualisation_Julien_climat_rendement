...
class AIAnalyzer:
    ...
    def agent_climate_similarity(self, zone_id, temperature_moyenne, precipitations_totales):
        prompt_climate = f"""
            ...
            - Renvoyer si possible le volume total annuel pour chaque couleur de vin si tu arrives à trouver (en hl).
            - si le volume total annuel pour une couleur de vin n'est pas connu, mettre "non connu".
